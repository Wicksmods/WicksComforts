...
function A:OnEnable()
    ...
    self:RegisterOptions(function(page, addon)
        ...
        y = O:Note(page, "The game paints every health bar the same green. This colours the player, target, focus, boss and party frames by class, in the class colours WickCore is set to: the game's own, or the Classic-era codes with /wickcore theme classic. Party and raid frames have a setting of their own, below.", y)
